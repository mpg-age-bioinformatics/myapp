...
dashapp = dash.Dash("privacy",url_base_pathname=f'{PAGE_PREFIX}/privacy/', meta_tags=META_TAGS, server=app, external_stylesheets=[dbc.themes.BOOTSTRAP], title="Privacy", assets_folder=app.config["APP_ASSETS"])# , assets_folder="/{APP_TITLE}/{APP_TITLE}/static/dash/")
